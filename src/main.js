...
numberInput.addEventListener('input', event=>{
    ...
    // Validar que haya una letra, agregando espacios cada 4 digitos, borrando espacios ingresados por el usuario, borrando el error al quitar la letra y el espacio final
    let regExp = /[A-z]/g;
    ...
    //mostrando los ceros cuando no se haya ingresado nada

    if(numberInput.value == ''){
        numberCard.innerText = '0000 0000 0000'
    }
});

// Ingreso dinamico del message
